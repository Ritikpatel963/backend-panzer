...
import { DEMO_CREDENTIALS } from '@/context/useAuthContext'
        ...
        <Col xl={4} lg={5} md={6}>
          <Card className="overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
            ...
            <div className="text-start mb-3">
              <div className="bg-light bg-opacity-50 border border-light rounded p-2">
                <div className="text-muted fs-12">Demo credentials (frontend-only)</div>
                <div className="fw-semibold fs-13">Email: {DEMO_CREDENTIALS.email}</div>
                <div className="fw-semibold fs-13">Password: {DEMO_CREDENTIALS.password}</div>
              </div>
            </div>
