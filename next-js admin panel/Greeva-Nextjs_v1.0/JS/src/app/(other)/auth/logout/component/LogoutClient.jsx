      ...
      <Row className="g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
        <Col xl={4} lg={5} md={6}>
          <Card className="overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
            ...
            <h4 className="fw-semibold mb-2 fs-18">{done ? 'You are Logged Out' : 'Logging you out...'}</h4>
            ...
            <div className="mb-3 text-start">
              <div className="bg-success-subtle p-3 rounded fst-italic fw-medium mb-0" role="alert">
                <p className="mb-0 text-success">
                  You have been successfully logged out of your account. To continue, please log in again.
                </p>
              </div>
            </div>
